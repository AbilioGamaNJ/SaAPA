...
const Perfil = () => {
  ...
  const upPhoto = async () => {
    try {
      ...
      await fetch(
        "http://localhost:3001/api/user/" + loggedUser.id,
        requestOptions
      );
      window.location.reload(false);
    } catch (e) {
        ...
        <div className="perfil-container">
          ...
          <div className="box-perfil2">
            ...
            <div className="cantoEsquerdo">
              <button className="btn_perfil" onClick={upPhoto}>
                Salvar Foto
              </button>
              <button className="btn_perfil" onClick={upPerfl}>
                Salvar alterações
              </button>
            </div>
          </div>
